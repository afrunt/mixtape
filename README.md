...
2. Сортує треки за номером треку (або за алфавітом імені файлу, якщо
   ...
   сторону.
3. Конвертує кожен трек у беззбитковий PCM WAV файл, за бажанням
...
вхідних даних, сканування кожного альбому, перевірка ємності, розподіл,
...
Додайте `--include-artist-name`, щоб префіксувати кожен рядок треку
...
* Довжини аудіокасет обмежені реальними стандартними значеннями:
  `46, 60, 90, 100, 110, 120, 130` хвилин. Ємність сторони завжди
  дорівнює половині довжини касети.
* Якщо один трек довший за найбільшу запитану сторону касети, або
  загальна тривалість альбому перевищує сумарну ємність усіх запитаних
  касет, скрипт завершується з чіткою помилкою до запису будь-якого
  результату.
